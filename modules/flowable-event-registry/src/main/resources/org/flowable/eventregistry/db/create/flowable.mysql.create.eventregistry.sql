...
CREATE TABLE FLW_EVENT_INSTANCE (ID_ VARCHAR(255) NOT NULL, EVENT_KEY_ VARCHAR(255) NULL, CATEGORY_ VARCHAR(255) NULL, EVENT_DEFINITION_KEY_ VARCHAR(255) NULL, TENANT_ID_ VARCHAR(255) NULL, CONSTRAINT PK_FLW_EVENT_INSTANCE PRIMARY KEY (ID_));
