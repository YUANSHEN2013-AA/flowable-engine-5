...
CREATE TABLE FLW_EVENT_INSTANCE (ID_ varchar(255) NOT NULL, EVENT_KEY_ varchar(255), CATEGORY_ nvarchar(255), EVENT_DEFINITION_KEY_ varchar(255), TENANT_ID_ varchar(255), CONSTRAINT PK_FLW_EVENT_INSTANCE PRIMARY KEY (ID_));
