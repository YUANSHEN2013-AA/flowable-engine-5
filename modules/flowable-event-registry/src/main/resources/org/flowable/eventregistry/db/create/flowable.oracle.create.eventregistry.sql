...
CREATE TABLE FLW_EVENT_INSTANCE (ID_ VARCHAR2(255) NOT NULL, EVENT_KEY_ VARCHAR2(255), CATEGORY_ VARCHAR2(255), EVENT_DEFINITION_KEY_ VARCHAR2(255), TENANT_ID_ VARCHAR2(255), CONSTRAINT PK_FLW_EVENT_INSTANCE PRIMARY KEY (ID_));
