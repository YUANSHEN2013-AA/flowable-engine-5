...
CREATE TABLE FLW_EVENT_INSTANCE (ID_ VARCHAR(255) NOT NULL, EVENT_KEY_ VARCHAR(255), CATEGORY_ VARCHAR(255), EVENT_DEFINITION_KEY_ VARCHAR(255), TENANT_ID_ VARCHAR(255), CONSTRAINT "FLW_EVENT_INSTANCE_pkey" PRIMARY KEY (ID_));
